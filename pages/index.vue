    ...
    <div>
        ...
        <div class="bruhtext mr-[10px] ml-[160px] text-justify">
            ...
            <div class="funiimg flex flex-row-reverse items-start">
                <img class="h-[200px] shadow-xl" src="https://media.tenor.com/cuwj6gJLLW8AAAAd/victory-royale-winner.gif"
                    alt="">
            ...
            <ul class="list-none">
                ...
                <li>
                    ...
                    <div class="letext flex flex-row-reverse items-start ">
                        <img class="h-[200px] shadow-xl"
                            src="https://thumbs.gfycat.com/BiodegradableSkeletalCottontail.webp" alt="">
                    ...
                    <ul class="ml-[20px]">
                        <li>
                            ...
                            <div class="moretext flex items-center">
                                <img class="h-[100px] mr-[10px] shadow-xl"
                                    src="https://i.ytimg.com/vi/u5R0H_pysFQ/maxresdefault.jpg" alt="">
                                <p class="indent-10">
                        ...
                        <li>
                            ...
                            <div class="moretext flex flex-row-reverse items-center">
                                <img class="h-[100px] ml-[10px] shadow-xl"
                                    src="https://images2.minutemediacdn.com/image/upload/c_fill,w_1080,ar_16:9,f_auto,q_auto,g_auto/shape%2Fcover%2Fsport%2Fpubg-06-89a3f1c559cf23f92d1ff0ffc3cbf7f2.jpg"
                                    alt="">
                                <p class="indent-10">
                        ...
                        <li>
                            ...
                            <div class="moretext flex items-center">
                                <img class="h-[100px] mr-[10px] shadow-xl"
                                    src="https://media.dragonblogger.com/wp-content/uploads/2022/02/15001349/Picture2-1536x864.png"
                                    alt="">
                                <p class="indent-10">
                                    In terms of ballistics and gunplay, PUBG went for something more realistic, except air
                                    isn't real.
                                    And the only thing affecting bullet trajectory is gravity. So forget everything you
                                    thought you know
                                    about assault rifles, because they now have an effective range of whatever. Basically if
                                    you put a 15x
                                    scope on a m249 machine gun and them go prone to apply the bipod, you now have a fully
                                    automatic, low
                        ...
                        <li>
                            ...
                            <div class="moretext flex flex-row-reverse items-start">
                                <img class="h-[100px] ml-[10px] shadow-xl"
                                    src="https://quantumshifting.files.wordpress.com/2012/08/red-pill-blue-pill.jpg" alt="">
                                <p class="indent-10">
                                    We've reached the point of no return and you now need to make a choice. You take the
                                    blue pill, remain
                                    ignorant of your surroundings and get sent back to lobby because you couldn't hear the
                                    guy sneaking up
                                    behind you. You take the red pill, enhance your senses and become one with your
                                    surroundings, so that no
                                    one may get close without you knowing it. However, if you choose the red pill, you will
                                    soon come to realize
                                    that there is a price that you have to pay. Your hearing and tinnitus by the age of 20.
                                    The game also had proximty
                                    voice chat, but Blue Hole disabled it in lobbies when they found out that it was only
                                    used to mic spamming streamers
                ...
                <li>
                    ...
                    <div class="letext flex flex-row-reverse items-start border-b-2 border-[#152856] pb-[15px]">
                        <div class="flex flex-col items-center">
                            <p class="indent-[10px] mr-[10px]">
                                But in the end, PUBG was fun and i had alot of fun playing it and to be honest, i don't even
                                notice most of
                                these issues until they were drastically improved in you guessed it.
                            </p>
                            <div class="flex items-center">
                                <img class="h-[170px] m-[10px]"
                                    src="https://thumbs.gfycat.com/BronzeUnripeBlackrussianterrier.webp" alt="">
                                <img class="h-[170px] m-[10px]"
                                    src="https://media.tenor.com/F1gWP60UTpYAAAAS/fortnite-meme.gif" alt="">
                                <h1 class="text-[50px]">F O R T N I T E</h1>
                                <img class="h-[170px] m-[10px]"
                                    src="https://media.tenor.com/dEjdaRZExUQAAAAd/fortnite-dance.gif" alt="">
                                <img class="h-[170px] m-[10px]"
                                    src="https://gifdb.com/images/high/fortnite-battle-royale-lore-explaining-meme-gwiejik8rftmq5wd.webp"
                                    alt="">
                            </div>
                            <!-- ddd -->
                        </div>
            ...
            <div class="cards flex flex-col items-center">
                ...
                <div class="flex items-center">
                    <NuxtLink to="/creators/SsethTzentach">
                        <MoreGarbage :title="'SsethTzentach'"
