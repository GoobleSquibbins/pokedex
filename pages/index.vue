    ...
    <div>
        ...
        <div class=" grid grid-cols-5 gap-5">
            <div class="flex flex-col items-center" v-for="item in data" :key="item.entry">
                <NuxtLink :to="'/entry/' + item.entry">
                    <div class="m-[10px] w-[220px] h-[350px] bg-white rounded-lg drop-shadow-2xl border-[1px] border-black flex flex-col items-center p-[5px]">
                        <img :src="item.sprite">
